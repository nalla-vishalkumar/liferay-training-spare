...
public class TutorLocalServiceImpl extends TutorLocalServiceBaseImpl {
    ...
    public int getTutorsCount(long groupId, long trainingId) {
        return tutorPersistence.countByG_G(groupId, trainingId);
    }
    ...
    public Tutor addTutor(long userId, long trainingId, String tutorName,
        ...
        System.out.println("incremented tutorId - " + tutorId);
        ...
        System.out.println("Data persisted for tutor - " + tutorId);
