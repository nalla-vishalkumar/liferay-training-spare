...
public class TrainingServiceHttp {
	public static java.util.List<training.book.sb.model.Training> getTrainings(
		...
		try {
			MethodKey methodKey = new MethodKey(TrainingServiceUtil.class,
					"getTrainings", _getTrainingsParameterTypes0);
			...
			return (java.util.List<training.book.sb.model.Training>)returnObj;
		}
	...
	private static final Class<?>[] _getTrainingsParameterTypes0 = new Class[] {
			long.class
		};
}